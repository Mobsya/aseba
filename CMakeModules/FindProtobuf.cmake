...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  cmake_parse_arguments(protobuf "" "EXPORT_MACRO;DESCRIPTORS;LITE;" "" ${ARGN})
  ...
  foreach(FIL ${PROTO_FILES})
    ...
    add_custom_command(
      ...
      COMMAND  protobuf::protoc
               "--cpp_out=${LITE}${DLL_EXPORT_DECL}${CMAKE_CURRENT_BINARY_DIR}"
...
function(PROTOBUF_GENERATE_JS SRCS)
  cmake_parse_arguments(protobuf "" "OUTPUT_DIR;" "" ${ARGN})
  if(NOT ARGN)
  ...
  if(protobuf_OUTPUT_DIR)
      set(OUTPUT_DIR ${protobuf_OUTPUT_DIR})
      message(${OUTPUT_DIR})
  endif()
  ...
  foreach(FIL ${PROTO_FILES})
    ...
    list(APPEND ${SRCS} ${OUTPUT_DIR}/${FIL_WE}_pb3.js)
    add_custom_command(
      OUTPUT  ${OUTPUT_DIR}/${FIL_WE}_pb3.js
      COMMAND  protobuf::protoc --js_out=${OUTPUT_DIR} --proto_path=${FIL_DIR} ${ABS_FIL}
      DEPENDS ${ABS_FIL} protobuf::protoc
      COMMENT "Running JS protocol buffer compiler on ${FIL}"
      VERBATIM )
  endforeach()
...
function(PROTOBUF_GENERATE_PYTHON SRCS)
  ...
  foreach(FIL ${ARGN})
    ...
    list(APPEND ${SRCS} "${CMAKE_CURRENT_BINARY_DIR}/${FIL_WE}_pb3.py")
    add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${FIL_WE}_pb3.py"
