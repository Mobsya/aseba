...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    add_custom_target(
        ...
        COMMAND ${QT_ANDROID_QT_ROOT}/bin/androiddeployqt --no-strip --verbose --output ${CMAKE_CURRENT_BINARY_DIR} --input ${CMAKE_CURRENT_BINARY_DIR}/qtdeploy.json --gradle ${TARGET_LEVEL_OPTIONS} ${INSTALL_OPTIONS} ${SIGN_OPTIONS}
    )
