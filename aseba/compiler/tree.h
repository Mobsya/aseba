...
struct Node {
    ...
    enum ReturnType { UNIT = 0, BOOL, INT };

    //! Constructor
    Node(const SourcePos& sourcePos) : sourcePos(sourcePos) {}

protected:
    // default copy-constructor, protected because we only want children to use it in their override
    // of shallowCopy()
...
struct BlockNode : Node {
    ...
    BlockNode* shallowCopy() const override {
    ...
    std::wstring toNodeName() const override {
        return L"block";
    }
};
...
struct ProgramNode : BlockNode {
    ...
    ProgramNode* shallowCopy() const override {
    ...
    void emit(PreLinkBytecode& bytecodes) const override;
    std::wstring toWString() const override {
        return L"ProgramBlock";
    }
    std::wstring toNodeName() const override {
        return L"program block";
    }
};
...
struct AssignmentNode : Node {
    ...
    AssignmentNode* shallowCopy() const override {
...
struct IfWhenNode : Node {
    bool edgeSensitive;  //!< if true, true block is triggered only if previous comparison was
                         //!< false ("when" block). If false, true block is triggered every time
                         //!< comparison is true
    unsigned endLine;    //!< line of end keyword

    //! Constructor
    IfWhenNode(const SourcePos& sourcePos) : Node(sourcePos) {}
    IfWhenNode* shallowCopy() const override {
        return new IfWhenNode(*this);
    }
...
struct FoldedIfWhenNode : Node {
    ...
    FoldedIfWhenNode* shallowCopy() const override {
        return new FoldedIfWhenNode(*this);
    }
...
struct WhileNode : Node {
    ...
    WhileNode* shallowCopy() const override {
...
struct FoldedWhileNode : Node {
    ...
    FoldedWhileNode* shallowCopy() const override {
        return new FoldedWhileNode(*this);
    }
...
struct EventDeclNode : Node {
    ...
    EventDeclNode* shallowCopy() const override {
...
struct EmitNode : Node {
    ...
    EmitNode* shallowCopy() const override {
...
struct SubDeclNode : Node {
    ...
    SubDeclNode* shallowCopy() const override {
    ...
    std::wstring toWString() const override;
    std::wstring toNodeName() const override {
        return L"subroutine declaration";
    }
};
...
struct CallSubNode : Node {
    ...
    CallSubNode* shallowCopy() const override {
        return new CallSubNode(*this);
    }
...
struct BinaryArithmeticNode : Node {
    ...
    BinaryArithmeticNode* shallowCopy() const override {
        return new BinaryArithmeticNode(*this);
    }
    ...
    std::wstring toWString() const override;
    std::wstring toNodeName() const override {
        return L"binary function";
    }

    static BinaryArithmeticNode* fromComparison(const SourcePos& sourcePos, Compiler::Token::Type op, Node* left,
                                                Node* right);
    static BinaryArithmeticNode* fromShiftExpression(const SourcePos& sourcePos, Compiler::Token::Type op, Node* left,
                                                     Node* right);
    static BinaryArithmeticNode* fromAddExpression(const SourcePos& sourcePos, Compiler::Token::Type op, Node* left,
                                                   Node* right);
    static BinaryArithmeticNode* fromMultExpression(const SourcePos& sourcePos, Compiler::Token::Type op, Node* left,
                                                    Node* right);
    static BinaryArithmeticNode* fromBinaryExpression(const SourcePos& sourcePos, Compiler::Token::Type op, Node* left,
                                                      Node* right);
};
...
struct UnaryArithmeticNode : Node {
    ...
    UnaryArithmeticNode* shallowCopy() const override {
        return new UnaryArithmeticNode(*this);
    }
...
struct ImmediateNode : Node {
    ...
    ImmediateNode* shallowCopy() const override {
        return new ImmediateNode(*this);
    }
...
struct StoreNode : Node {
    ...
    StoreNode* shallowCopy() const override {
    ...
    std::wstring toWString() const override;
    std::wstring toNodeName() const override {
        return L"variable access (write)";
    }
...
struct LoadNode : Node {
    ...
    LoadNode* shallowCopy() const override {
...
struct ArrayWriteNode : Node {
    ...
    ArrayWriteNode* shallowCopy() const override {
...
struct ArrayReadNode : Node {
    ...
    ArrayReadNode* shallowCopy() const override {
...
struct LoadNativeArgNode : Node {
    ...
    LoadNativeArgNode* shallowCopy() const override {
...
struct CallNode : Node {
    ...
    CallNode* shallowCopy() const override {
...
struct ReturnNode : Node {
    ...
    ReturnNode* shallowCopy() const override {
...
struct TupleVectorNode : AbstractTreeNode {
    ...
    TupleVectorNode* shallowCopy() const override {
        return new TupleVectorNode(*this);
    }
...
struct MemoryVectorNode : AbstractTreeNode {
    ...
    MemoryVectorNode* shallowCopy() const override {
        return new MemoryVectorNode(*this);
    }
...
struct ArithmeticAssignmentNode : AbstractTreeNode {
    ...
    ArithmeticAssignmentNode* shallowCopy() const override {
        return new ArithmeticAssignmentNode(*this);
    }
    ...
    std::wstring toWString() const override;
    std::wstring toNodeName() const override {
        return L"arithmetic assignment";
    }

    static ArithmeticAssignmentNode*
    fromArithmeticAssignmentToken(const SourcePos& sourcePos, Compiler::Token::Type token, Node* left, Node* right);
...
struct UnaryArithmeticAssignmentNode : AbstractTreeNode {
    ...
    UnaryArithmeticAssignmentNode* shallowCopy() const override {
        return new UnaryArithmeticAssignmentNode(*this);
    }
    ...
    std::wstring toWString() const override;
    std::wstring toNodeName() const override {
        return L"unary arithmetic assignment";
    }
};
