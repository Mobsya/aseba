...
void HelpViewer::showHelp(helpType type) {
    ...
    switch(type) {
        ...
        case HelpViewer::USERMANUAL: filename += "asebausermanual.html"; break;
        case HelpViewer::STUDIO: filename += "asebastudio.html"; break;
        case HelpViewer::LANGUAGE: filename += "asebalanguage.html"; break;
    }
