...
protected:
    ...
    //! Block all write operations, used by invasive plugins when they do something hacky with the
    //! underlying data stream
    virtual void blockWrite() = 0;

    //! Unblock write operatinos, used by invasive plugins when they do something hacky with the
    //! underlying data stream
