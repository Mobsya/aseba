...
namespace Aseba
{
	...
	static const AuthorInfos authorList = {
		...
		{
			u8"Corentin Jabot",
			u8"corentin dot jabot at mobsya dot org",
			u8"",
			u8"core programmer, architecture, packaging, bug fixing",
			{ u8"core", u8"studio", u8"packaging", u8"blockly", u8"thymio-suite", u8"thymio-device-manager", }
		},
	};
	...
	static const AuthorInfos thankToList = {
		...
		},
		{
			...
			u8"",
			u8"French translation, packaging, quality insurance, bug reporting, project coordinator",
			{ u8"packaging", u8"translation", u8"vpl", u8"studio", u8"blockly", u8"thymio-suite", }
		},
		{
			u8"Dean Brettle",
		...
		},
		{
			...
			u8"",
			u8"developer, bug reporting and fixing",
			{ u8"vpl", }
		},
		{
			u8"Yves Piguet",
		...
		},
		{
			...
			u8"",
			u8"Textures for Thymio 3D model, design Thymio suite",
			{ u8"simulator", u8"thymio-suite", }
		},
		{
