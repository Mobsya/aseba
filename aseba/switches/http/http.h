...
protected:
    ...
    // helper functions
    // bool getNodeAndVarPos(const std::string& nodeName, const std::string& variableName, unsigned&
    // nodeId, unsigned& pos) const;
    //        bool getVarPos(const unsigned nodeId, const std::string& variableName, unsigned& pos)
    //        const;
